package dev.blumdlc.client.msdf;
...
import dev.blumdlc.client.msdf.FontData.AtlasData;
import dev.blumdlc.client.msdf.FontData.GlyphData;
import dev.blumdlc.client.msdf.FontData.MetricsData;
import dev.blumdlc.client.providers.ResourceProvider;
...
public final class MsdfFont {
	...
	public static class Builder {
		...
		public MsdfFont.Builder data(String dataFileName) {
			this.dataIdentifer = Identifier.of("blumdlc", "fonts/" + dataFileName + ".json");
			return this;
		}
		
		public MsdfFont.Builder atlas(String atlasFileName) {
			this.atlasIdentifier = Identifier.of("blumdlc", "fonts/" + atlasFileName + ".png");
			return this;
		}
